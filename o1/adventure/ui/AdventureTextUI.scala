...
object AdventureTextUI extends App {
  ...
  private val game = new MusicAdventure
  ...
  private def printAreaInfo() = {
    ...
    println("\n\n" + area.name + "\t\t\tKello on 18:" + (game.turnCount+game.timeLimit))
  ...
  private def playTurn() = {
    ...
    val turnReport = this.game.playTurn(command)    // tänne halutaan stringiä
